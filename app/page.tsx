  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            <div className="space-y-6 md:space-y-8 text-center lg:text-left">
              <div className="space-y-4">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-black leading-tight">
                  Hi, I'm <span className="underline decoration-4 decoration-black">Your Name</span>
                </h1>
                <p className="text-lg md:text-xl text-gray-600">Full Stack Developer & UI/UX Designer</p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-6">
              <p className="text-base md:text-lg text-gray-600 leading-relaxed">
                ...
                specialize in creating seamless user experiences backed by robust, scalable code.
              </p>
              <p className="text-base md:text-lg text-gray-600 leading-relaxed">
      ...
      <section id="projects" className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600">Some of my recent work that I'm proud of</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            <Card className="group hover:shadow-xl transition-all duration-300 border-black">
              ...
              <CardHeader>
                ...
                <CardDescription>A full-featured e-commerce solution with payment integration</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 border-black">
              ...
              <CardHeader>
                ...
                <CardDescription>A collaborative project management tool with real-time updates</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="outline" className="border-black text-black">
      ...
      <section id="skills" className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600">The tools and technologies I work with</p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            <Card className="border-black">
              ...
              <CardContent className="space-y-3">
                <div className="flex flex-wrap gap-2">
                  <Badge className="bg-black text-white hover:bg-gray-800">React</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Vue.js</Badge>
                  ...
                  <Badge className="bg-black text-white hover:bg-gray-800">JavaScript</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">HTML5</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">CSS3</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Tailwind CSS</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-black">
              ...
              <CardContent className="space-y-3">
                <div className="flex flex-wrap gap-2">
                  <Badge className="bg-black text-white hover:bg-gray-800">Node.js</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Express</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Python</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Django</Badge>
                  ...
                  <Badge className="bg-black text-white hover:bg-gray-800">Redis</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">GraphQL</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-black">
              ...
              <CardContent className="space-y-3">
                <div className="flex flex-wrap gap-2">
                  ...
                  <Badge className="bg-black text-white hover:bg-gray-800">Git</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">GitHub Actions</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Jest</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Cypress</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Webpack</Badge>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-black">
              ...
              <CardContent className="space-y-3">
                <div className="flex flex-wrap gap-2">
                  <Badge className="bg-black text-white hover:bg-gray-800">Figma</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Adobe XD</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Photoshop</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Illustrator</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">UI/UX Design</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Prototyping</Badge>
                  <Badge className="bg-black text-white hover:bg-gray-800">Wireframing</Badge>
                </div>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="education" className="py-12 md:py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12 md:mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">Education & Certifications</h2>
          </div>
              ...
              <CardHeader>
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                  <div>
                    ...
                    <CardDescription className="mt-2">University Name</CardDescription>
                  </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <p className="text-gray-300">© 2024 Your Name. All rights reserved.</p>
            </div>
            <div className="flex space-x-6">
